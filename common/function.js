...
export const sendEmail = (to, data, type = 'change') => {
  return new Promise(async (resolve, reject) => {
    const options = {
      ...
      body:
      {
        ...
        from: { email: 'no-reply@adel-tour.com' },
...
export const generateTokenResetPassword = (userSign) => {
  return jwt.sign({ id: userSign }, process.env.SECRET_TOKEN, { expiresIn: '15m' })
}
